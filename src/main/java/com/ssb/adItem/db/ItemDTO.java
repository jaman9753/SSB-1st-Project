...
public class ItemDTO {
	...
	private int options_price; // 옵션 추가금
	...
	public String toString() {
		return "ItemDTO [item_id=" + item_id + ", item_name=" + item_name + ", item_price=" + item_price
				+ ", item_img_main=" + item_img_main + ", item_img_sub=" + item_img_sub + ", item_img_logo="
				+ item_img_logo + ", category_id=" + category_id + ", category_code=" + category_code
				+ ", category_sport=" + category_sport + ", category_major=" + category_major + ", category_sub="
				+ category_sub + ", category_brand=" + category_brand + ", options_id=" + options_id
