    ...
    <div id="login_wrap">
        <div class="main-container">
            ...
            <div class="form-container" style="width: 380px;">
                ...
                <div class="info">
                    <span>
                        <button style="border: none; background-color: transparent; font-size: 12px; border: none;" onclick="window.location.href='./findID.fi'">아이디 찾기</button>
                    </span>
                    <span>&nbsp;</span>
                    <span>
                ...
                <div class="d-grid gap-2" style="text-align: center;">
                    <a href="javascript:kakaoLogin();"><img src="./login/img/kakao_login.png" alt="카카오계정 로그인" /></a>
